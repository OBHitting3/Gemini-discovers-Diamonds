...
GameConfig.EventThemes = {
    {
        ...
        gardenBoost = 1.0,
        shopBonus = 0,
        description = "Default relaxed vibes",
    },
    {
        name = "Desert Bloom",
        gardenBoost = 1.5,
        shopBonus = 0,
        description = "Garden growth 50% faster",
    },
    {
        name = "Retro Revival",
        gardenBoost = 1.0,
        shopBonus = 0.2,
        description = "Vintage items 20% cheaper in shops",
    },
    {
        name = "Modernism Week",
        gardenBoost = 1.0,
        shopBonus = 0,
        description = "Limited MCM drops + bonus Prestige",
    },
    {
        name = "Sunset Soiree",
        gardenBoost = 1.0,
        shopBonus = 0,
        description = "Special evening fashion events",
    },
    {
        name = "Cactus Festival",
        gardenBoost = 2.0,
        shopBonus = 0.1,
        description = "Double garden growth + shop discounts",
    },
}
